# @xdanangelxoqenpm/asperiores-maiores-omnis

<a href="https://www.npmjs.com/package/@xdanangelxoqenpm/asperiores-maiores-omnis"><img alt="npm version" src="https://badge.fury.io/js/@xdanangelxoqenpm/asperiores-maiores-omnis.svg"></a>
<a href="https://npmjs.org/package/@xdanangelxoqenpm/asperiores-maiores-omnis"><img alt="Downloads" src="http://img.shields.io/npm/dm/@xdanangelxoqenpm/asperiores-maiores-omnis.svg"></a>
[![Build Status](https://travis-ci.org/mosch/@xdanangelxoqenpm/asperiores-maiores-omnis.svg?branch=master)](https://travis-ci.org/mosch/@xdanangelxoqenpm/asperiores-maiores-omnis)
[![Design](https://contribute.design/api/shield/mosch/@xdanangelxoqenpm/asperiores-maiores-omnis)](https://contribute.design/mosch/@xdanangelxoqenpm/asperiores-maiores-omnis)
...
Just use your favorite package manager to add `@xdanangelxoqenpm/asperiores-maiores-omnis` to your project:

```sh
yarn add @xdanangelxoqenpm/asperiores-maiores-omnis

npm i --save @xdanangelxoqenpm/asperiores-maiores-omnis

pnpm add @xdanangelxoqenpm/asperiores-maiores-omnis
```

## [Demo](https://@xdanangelxoqenpm/asperiores-maiores-omnis.netlify.com/)
...
import AvatarEditor from '@xdanangelxoqenpm/asperiores-maiores-omnis'
...
drag and drop support to anything really easy. Here is an example how to use it with @xdanangelxoqenpm/asperiores-maiores-omnis:
